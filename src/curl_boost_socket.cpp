...
void curl_boost_socket::subscribe_read()
{
	...
	m_socket.async_wait(socket_t::wait_read, [socket = this](const error_code& ec) noexcept {
...
void curl_boost_socket::subscribe_write()
{
	...
	m_socket.async_wait(socket_t::wait_write, [socket = this](const error_code& ec) noexcept {
