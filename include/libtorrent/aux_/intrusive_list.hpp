...
//
// Disadvantages:
// - Objects not in any `ownership_intrusive_list` still incur storage overhea.d of next/prev pointers.
// - Each object can belong to only one `ownership_intrusive_list` at once (when using unique_ptr).
